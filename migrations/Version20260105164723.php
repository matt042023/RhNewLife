 ...
 */
final class Version20260105164723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointment_participants (id INT AUTO_INCREMENT NOT NULL, appointment_id INT NOT NULL, user_id INT NOT NULL, linked_absence_id INT DEFAULT NULL, presence_status VARCHAR(20) NOT NULL, confirmed_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_88AB679FE5B533F9 (appointment_id), INDEX IDX_88AB679FA76ED395 (user_id), INDEX IDX_88AB679FBA3BF8C8 (linked_absence_id), UNIQUE INDEX unique_appointment_user (appointment_id, user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

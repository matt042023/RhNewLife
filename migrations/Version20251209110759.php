 ...
 */
final class Version20251209110759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE absence (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, absence_type_id INT DEFAULT NULL, validated_by_id INT DEFAULT NULL, type VARCHAR(50) DEFAULT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, reason LONGTEXT DEFAULT NULL, status VARCHAR(30) NOT NULL, justification_status VARCHAR(30) DEFAULT NULL, justification_deadline DATETIME DEFAULT NULL, rejection_reason LONGTEXT DEFAULT NULL, admin_comment LONGTEXT DEFAULT NULL, affects_planning TINYINT(1) DEFAULT 0 NOT NULL, working_days_count DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_765AE0C9A76ED395 (user_id), INDEX IDX_765AE0C9CCAA91B (absence_type_id), INDEX IDX_765AE0C9C69DE5E5 (validated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE affectation (id INT AUTO_INCREMENT NOT NULL, planning_mois_id INT NOT NULL, user_id INT DEFAULT NULL, villa_id INT NOT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, type VARCHAR(20) NOT NULL, statut VARCHAR(30) NOT NULL, is_from_squelette TINYINT(1) NOT NULL, commentaire LONGTEXT DEFAULT NULL, INDEX IDX_F4DD61D3276A1453 (planning_mois_id), INDEX IDX_F4DD61D3A76ED395 (user_id), INDEX IDX_F4DD61D3285D9761 (villa_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE contract (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, parent_contract_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, template_id INT DEFAULT NULL, validated_by_id INT DEFAULT NULL, type VARCHAR(50) NOT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, essai_end_date DATE DEFAULT NULL, base_salary NUMERIC(10, 2) NOT NULL, prime NUMERIC(10, 2) DEFAULT NULL, working_days JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', villa VARCHAR(100) DEFAULT NULL, activity_rate NUMERIC(3, 2) DEFAULT \'1.00\' NOT NULL, weekly_hours NUMERIC(5, 2) DEFAULT NULL, mutuelle TINYINT(1) DEFAULT 0 NOT NULL, prevoyance TINYINT(1) DEFAULT 0 NOT NULL, status VARCHAR(30) DEFAULT \'DRAFT\' NOT NULL, version INT DEFAULT 1 NOT NULL, termination_reason LONGTEXT DEFAULT NULL, notes LONGTEXT DEFAULT NULL, draft_file_url VARCHAR(500) DEFAULT NULL, signed_file_url VARCHAR(500) DEFAULT NULL, signature_token VARCHAR(100) DEFAULT NULL, token_expires_at DATETIME DEFAULT NULL, signature_ip VARCHAR(45) DEFAULT NULL, signature_user_agent LONGTEXT DEFAULT NULL, validated_at DATETIME DEFAULT NULL, signed_at DATETIME DEFAULT NULL, terminated_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_E98F2859D7605360 (signature_token), INDEX IDX_E98F2859A76ED395 (user_id), INDEX IDX_E98F28594E5AF28D (parent_contract_id), INDEX IDX_E98F2859B03A8386 (created_by_id), INDEX IDX_E98F28595DA0FB8 (template_id), INDEX IDX_E98F2859C69DE5E5 (validated_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, contract_id INT DEFAULT NULL, absence_id INT DEFAULT NULL, formation_id INT DEFAULT NULL, element_variable_id INT DEFAULT NULL, validated_by_id INT DEFAULT NULL, uploaded_by_id INT DEFAULT NULL, file_name VARCHAR(255) NOT NULL, original_name VARCHAR(255) NOT NULL, type VARCHAR(50) NOT NULL, status VARCHAR(20) DEFAULT \'pending\' NOT NULL, uploaded_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, mime_type VARCHAR(100) DEFAULT NULL, file_size INT DEFAULT NULL, version INT DEFAULT 1 NOT NULL, archived_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', archive_reason LONGTEXT DEFAULT NULL, retention_years INT DEFAULT NULL, validated_at DATETIME DEFAULT NULL, rejected_at DATETIME DEFAULT NULL, rejection_reason LONGTEXT DEFAULT NULL, INDEX IDX_D8698A76A76ED395 (user_id), INDEX IDX_D8698A762576E0FD (contract_id), INDEX IDX_D8698A762DFF238F (absence_id), INDEX IDX_D8698A765200282E (formation_id), INDEX IDX_D8698A7659A52623 (element_variable_id), INDEX IDX_D8698A76C69DE5E5 (validated_by_id), INDEX IDX_D8698A76A2B28FE8 (uploaded_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rendez_vous (id INT AUTO_INCREMENT NOT NULL, created_by_id INT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, start_at DATETIME NOT NULL, end_at DATETIME NOT NULL, type VARCHAR(20) NOT NULL, impact_garde TINYINT(1) NOT NULL, statut VARCHAR(20) NOT NULL, couleur VARCHAR(7) DEFAULT NULL, INDEX IDX_65E8AA0AB03A8386 (created_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
